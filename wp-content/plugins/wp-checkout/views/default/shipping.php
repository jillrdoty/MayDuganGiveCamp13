            ...
            <ul>
                ...
                <?php if (!empty($items_count) && $items_count != 0) : ?>
                    <?php if ($this -> get_option('shippingcalc') == "Y" || $this -> get_option('enablecoupons') == "Y") : ?>
                        <li><?php _e('Sub Total', $this -> plugin_name); ?>: <strong><?php echo $wpcoHtml -> currency_price($st); ?></strong></li>
                ...
                <?php endif; ?>
                <li><?php _e('Total Price', $this -> plugin_name); ?>: <strong><u><?php echo $wpcoHtml -> currency_price($total_price); ?></u></strong></li>
            </ul>
        </div>
	</fieldset>
</div>*/ ?>
            ...
            <h3><?php _e('Shipping Method', $this -> plugin_name); ?></h3>
                ...
                <?php if (empty($onlyoneshipmethod) || $onlyoneshipmethod == false) : ?>
                    <?php if ($shippingmethodsdisplay == "select") : ?>
                    	<select onchange="wpco_shipmethodchange(this.value, true);" id="<?php echo $this -> pre; ?>shipmethod" name="<?php echo $this -> pre; ?>shipmethod">
                    <?php endif; ?>
