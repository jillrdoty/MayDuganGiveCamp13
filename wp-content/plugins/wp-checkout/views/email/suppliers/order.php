                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php foreach ($option_ids as $option_id) : ?>
                                                                        ...
                                                                        <?php if ($option = $wpcoDb -> find($conditions = array('id' => $option_id), $fields = array('id', 'title', 'addprice', 'price'), $order = array('id', "DESC"), $assign = true)) : ?>
                                                                            <?php echo $option -> title; ?><?php echo (!empty($option -> addprice) && $option -> addprice == "Y") ? ' (' . __('+', $this -> plugin_name) . $wpcoHtml -> currency_price($option -> price) . ')' : ''; ?>
                                                        ...
                                                        <?php else : ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
																	...
																	<?php echo (!empty($option -> addprice) && $option -> addprice == "Y" && !empty($option -> price)) ? ' (' . __('+', $this -> plugin_name) . $optionprice . ')' : ''; ?>
                                                                </td>
                                                            </tr>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                            ...
                                            <?php if (!empty($item -> product -> cfields)) : ?>
                                                <?php foreach ($item -> product -> cfields as $field_id) : ?>
                                                    ...
                                                    <?php if ($field = $wpcoDb -> find(array('id' => $field_id))) : ?>
                                                        ...
                                                        <tr>
                                                            <td><?php echo $field -> title; ?><?php echo (!empty($field -> addprice) && $field -> addprice == "Y" && !empty($field -> price)) ? ' (' . __('+', $this -> plugin_name) . $wpcoHtml -> currency_price($field -> price) . ')' : ''; ?></td>
