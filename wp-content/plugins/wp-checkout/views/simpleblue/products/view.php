        ...
        <div class="<?php echo $this -> pre; ?>images">
            <?php if ($this -> get_option('cropthumb') == "Y") : ?>
                ...
                <?php if (file_exists($imagefull) && filesize($imagefull) > 0) : ?>
                    ...
                    <span class="clicktoenlarge"><?php echo $wpcoHtml -> link($captions['product']['clicktoenlarge'], $wpcoHtml -> image_url($product -> image -> name), array('class' => "colorbox", 'title' => esc_attr($product -> title))); ?></span>
                <?php else : ?>
