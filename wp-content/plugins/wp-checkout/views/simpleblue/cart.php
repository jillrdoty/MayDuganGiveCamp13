					...
					<?php if (!empty($discounts)) : ?>
						...
						<?php foreach ($discounts as $discount) : ?>
							<tr class="total">
								...
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td nowrap="nowrap">- <?php echo ($discount -> coupon -> discount_type == "fixed") ? $wpcoHtml -> currency_price($discount -> coupon -> discount) : $discount -> coupon -> discount; ?><?php echo ($discount -> coupon -> discount_type == "percentage") ? '&#37;' : ''; ?></td>
								<td>&nbsp;</td>
							</tr>
						<?php endforeach; ?>
					<?php endif; ?>
