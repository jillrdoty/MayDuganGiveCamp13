			...
			<div class="alignleft actions">
				...
				<select onchange="change_action(this.value);" name="action" class="widefat" style="width:auto;">
                    ...
                    <?php if (!$this -> is_supplier()) : ?>
						<option value="activate"><?php _e('Activate', $this -> plugin_name); ?></option>	<!-- neha -->
						<option value="deactivate"><?php _e('De-Activate', $this -> plugin_name); ?></option><!-- neha -->
		...
		<table class="widefat">
			<thead>
				<tr>
					...
					<th colspan="3"><?php _e('Product', $this -> plugin_name); ?></th>
					...
					<th><?php _e('Min Order', $this -> plugin_name); ?></th>
