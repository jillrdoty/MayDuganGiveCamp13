        	...
        	<tbody>
            	...
            	<?php foreach ($this -> extensions as $extension) : ?>                
                	...
                	<tr class="<?php echo $class = (empty($class)) ? 'alternate' : ''; ?>">
                		<th>
                			<a title="<?php echo esc_attr($extension['name']); ?>" onclick="jQuery.colorbox({title:'<?php echo $extension['name']; ?>', iframe:true, width:'80%', height:'80%', href:'<?php echo $extension['link']; ?>'}); return false;" href="<?php echo $extension['link']; ?>" style="border:none;"><img src="<?php echo $img; ?>" border="0" style="border:none; width:75px; height:75px;" alt="<?php echo $extension['slug']; ?>" /></a>
                		</th>
                    	<th>
