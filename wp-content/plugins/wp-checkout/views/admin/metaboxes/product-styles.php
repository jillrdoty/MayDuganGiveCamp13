...
function add_variationoption(title, price) {
	...
	optionhtml += '</tbody>';
	optionhtml += '</table>';
	optionhtml += '<a href="" onclick="if (confirm(\'<?php _e('Are you sure you want to remove this option?', $this -> plugin_name); ?>\')) { delete_option(\'' + optioncount + '\'); } return false;"><?php _e('Remove this option', $this -> plugin_name); ?></a><br/><br/>';
	optionhtml += '</fieldset>';
	optionhtml += '</div>';
...
function delete_option(countid) {
