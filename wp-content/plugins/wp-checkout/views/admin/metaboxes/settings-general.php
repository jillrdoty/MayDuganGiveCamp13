                                    ...
                                    <?php if ($states = $wpcoDb -> find_all(array('country_id' => $country_id), array('id', 'name'), array('name', "ASC"))) : ?>
                                    	<ul>
                                    		<?php foreach ($states as $state) : ?>
                                    			<li>
                                    				<input <?php echo (!empty($marketstates) && in_array($state -> id, $marketstates)) ? 'checked="checked"' : ''; ?> type="checkbox" name="marketstates[]" value="<?php echo $state -> id; ?>" id="marketstate-<?php echo $state -> id; ?>" />
