        		...
        		<?php foreach ($_POST['newvariation']['options'] as $option) : ?>
        			...
        			<div id="newoption<?php echo $optioncount; ?>">
						<fieldset>
							...
							<a href="" onclick="if (confirm('<?php _e('Are you sure you want to remove this option?', $this -> plugin_name); ?>')) { delete_option('<?php echo $optioncount; ?>'); } return false;"><?php _e('Remove this option', $this -> plugin_name); ?></a><br/><br/>
						</fieldset>
					</div>
